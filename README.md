...
3. Replace `YOUR_TMDB_API_KEY_HERE` in `js/api.js`

### OMDB / IMDB (Ratings + Metadata)
1. Get key at [omdbapi.com/apikey.aspx](https://www.omdbapi.com/apikey.aspx)
2. Replace `YOUR_OMDB_API_KEY_HERE` in `js/api.js`

### Letterboxd
API is in private beta — apply at [letterboxd.com/api-beta](https://letterboxd.com/api-beta/).
Stubs in `js/api.js` match the real API shape for drop-in replacement.
